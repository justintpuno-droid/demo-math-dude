...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lemma — Competition Math, Open to Everyone" },
      {
        name: "description",
        content:
          "Free, AI-powered competition math training. AMC, AIME, and MATHCOUNTS practice with adaptive problems and Socratic hints — built to democratize access beyond elite prep schools.",
      },
      { name: "author", content: "Lemma" },
      { property: "og:title", content: "Lemma — Competition Math, Open to Everyone" },
      {
        property: "og:description",
        content:
          "Free, AI-powered competition math training. Practice AMC, AIME, and MATHCOUNTS with adaptive problems and hints.",
      },
